      ...
      <div className="container mx-auto mb-24">
        ...
        >
          <div className="flex flex-col flex-1 gap-y-8">
            ...
            >
              <Image src={"/icons/logo.svg"} width={50} height={50} alt="" />
            </Link>
            {/* text 
            ...
            <div className="flex flex-col gap-y-4 font-semibold">
              ...
              <div className="flex items-center gap-x-[10px]">
                <FaEnvelope />
                <div className="font-medium">office@reca.com</div>
              </div>
            </div>
          </div>
          {/* links */}
          <div className="flex-1 flex flex-col xl:items-center">
            <div>
              <h3 className="h3 font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-500">
                Company
              </h3>
          ...
          <div className="flex-1">
            ...
            <form className="flex gap-x-2 h-14">
              ...
              <button
                type="submit"
                className="btn btn-sm bg-gradient-to-r from-blue-600 to-green-500 w-24"
              >
                Submit
              </button>
            </form>
